...
//TODO Hacer 3 timers, cada uno con su estructura y 2 procesos, uno que solo 
//     arranque a los demas. Y el otro que se encienda 3 veces com timer y leds diferentes.
...
PROCESS_THREAD(counter, ev, data)
{
  ...
  while(1) {
    PROCESS_WAIT_EVENT_UNTIL(active);
    printf("Counter: %u\n", counter++); 
